...
export const addPlace = (title, image, location) => {
    ...
    return async dispatch => {
        ...
        try {
            ...
            dispatch({ type:ADD_PLACE, placeData: { id:dbResult.insertId, title: title, image:newPath, address:address, coords:location} });
        } catch (err) {
            console.log(err);
            throw err;
        }
...
export const loadPlaces = () => {
    ...
    return async dispatch => {
        ...
        try {
            ...
            console.log(dbResult);
            dispatch({ type:SET_PLACES, placeData: dbResult.rows._array });
        } catch (err) {
            console.log(err);
            throw err;
        }
